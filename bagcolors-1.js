...
BW, MY, DR, LR - 4 bags can contain SG
...
'shiny violet bags contain 1 faded brown bags, 1 dull red bags',
'muted maroon bags contain 4 pale lime bags',
'pale magenta bags contain 2 striped coral bags, 1 shiny orange bags, 3 vibrant white bags, 4 posh cyan bags',
...
'wavy red bags contain 4 drab white bags, 1 plaid silver bags',
...
'mirrored tomato bags contain 1 posh turquoise bags, 2 bright aqua bags',
'clear lavender bags contain 3 plaid bronze bags, 4 faded plum bags, 2 muted coral bags, 1 posh chartreuse bags',
'light cyan bags contain 1 plaid tan bags, 2 muted cyan bags, 3 dim cyan bags, 1 pale gray bags',
'plaid lavender bags contain 4 bright cyan bags, 1 dim aqua bags, 3 muted orange bags',
...
'vibrant cyan bags contain 4 dim tomato bags, 1 dull green bags, 5 light silver bags, 2 striped gold bags',
...
'clear magenta bags contain 1 striped brown bags, 1 dull black bags, 5 light lime bags',
'plaid indigo bags contain 5 wavy purple bags, 2 pale blue bags',
'plaid brown bags contain 4 striped salmon bags',
'dull gold bags contain 2 mirrored green bags, 1 shiny coral bags, 4 shiny red bags',
'dark white bags contain 3 muted black bags, 1 vibrant yellow bags, 4 dotted chartreuse bags, 3 mirrored white bags',
...
'faded gold bags contain 1 pale bronze bags, 4 dim gold bags, 1 vibrant aqua bags, 2 bright aqua bags',
...
'drab white bags contain 1 clear lavender bags, 3 posh maroon bags',
...
'posh red bags contain 5 dim chartreuse bags, 1 shiny aqua bags, 1 wavy black bags',
...
'posh lavender bags contain 2 drab silver bags, 1 drab cyan bags',
'plaid olive bags contain 5 vibrant yellow bags, 1 striped bronze bags',
...
'muted indigo bags contain 5 posh chartreuse bags, 1 mirrored green bags, 3 dark brown bags, 1 dark orange bags',
...
'drab cyan bags contain 3 dull indigo bags, 1 vibrant indigo bags',
'striped purple bags contain 1 faded blue bags, 3 faded fuchsia bags, 3 pale maroon bags',
'dim aqua bags contain no other bags',
'pale olive bags contain 1 muted indigo bags',
'striped tan bags contain 4 light coral bags, 4 dull violet bags, 3 dim purple bags, 5 dull yellow bags',
'dull black bags contain 1 dotted beige bags',
...
'muted magenta bags contain 5 shiny blue bags, 1 faded olive bags, 4 drab brown bags, 3 dull violet bags',
'muted lime bags contain 5 light blue bags, 1 vibrant lavender bags',
...
'muted purple bags contain 1 drab tan bags',
'dim brown bags contain 4 dotted tan bags',
'drab lime bags contain 1 mirrored green bags, 5 clear lime bags, 3 posh yellow bags, 5 pale yellow bags',
'wavy aqua bags contain 1 faded silver bags',
'striped magenta bags contain 2 mirrored aqua bags, 1 dotted gold bags',
...
'shiny plum bags contain 5 vibrant coral bags, 3 dotted gray bags, 1 pale lime bags, 4 plaid green bags',
'faded violet bags contain 1 dark crimson bags, 5 pale gray bags, 1 pale olive bags',
'faded olive bags contain 4 wavy indigo bags',
'drab green bags contain 1 vibrant yellow bags, 1 posh tomato bags, 1 dull yellow bags, 5 shiny bronze bags',
'shiny black bags contain 3 clear gray bags, 4 dim tomato bags',
'dull coral bags contain 1 pale cyan bags, 1 light brown bags',
'mirrored coral bags contain 1 dark tomato bags, 3 vibrant coral bags, 3 posh lime bags, 3 pale fuchsia bags',
'faded white bags contain 1 light silver bags, 3 striped turquoise bags, 3 dark green bags, 3 posh orange bags',
'wavy orange bags contain 2 dotted indigo bags, 1 vibrant indigo bags, 4 dull teal bags, 3 striped gold bags',
'plaid beige bags contain 4 pale blue bags',
'plaid green bags contain 1 mirrored bronze bags, 3 mirrored purple bags, 5 shiny coral bags, 5 posh yellow bags',
'mirrored tan bags contain 1 faded blue bags',
'plaid violet bags contain 2 faded blue bags',
'shiny coral bags contain 3 vibrant bronze bags, 5 dull salmon bags',
'dim beige bags contain 3 plaid magenta bags, 2 light gold bags, 1 shiny blue bags, 5 bright teal bags',
'pale coral bags contain 1 faded orange bags, 3 dark turquoise bags',
'mirrored crimson bags contain 2 dull silver bags',
'dim tan bags contain 3 light tomato bags, 4 dotted chartreuse bags',
'striped cyan bags contain 1 faded violet bags, 3 dotted lavender bags, 4 light lavender bags, 1 drab fuchsia bags',
'dull turquoise bags contain 3 bright teal bags, 1 faded blue bags, 5 bright magenta bags',
...
'wavy lavender bags contain 4 pale cyan bags, 4 vibrant yellow bags, 1 vibrant white bags',
'pale green bags contain 3 dark indigo bags, 3 shiny gray bags',
'dark aqua bags contain 3 faded turquoise bags, 3 vibrant indigo bags, 3 dull salmon bags, 1 dotted gray bags',
'dim gray bags contain 1 faded silver bags, 3 muted red bags, 2 wavy orange bags, 1 posh beige bags',
'clear black bags contain 4 vibrant plum bags, 3 bright brown bags, 2 dark gray bags, 1 clear teal bags',
...
'light maroon bags contain 1 drab cyan bags',
'vibrant fuchsia bags contain 5 drab crimson bags',
'faded gray bags contain 3 mirrored aqua bags',
'wavy chartreuse bags contain 4 muted orange bags, 2 clear blue bags, 1 muted tan bags, 2 clear lime bags',
...
'muted white bags contain 1 faded tomato bags',
...
'drab plum bags contain 5 plaid green bags, 5 striped lime bags, 1 dotted teal bags',
'dark olive bags contain 2 wavy plum bags',
'pale lime bags contain 4 dark orange bags, 5 dim black bags, 1 dull white bags',
'striped fuchsia bags contain 4 bright orange bags, 3 pale maroon bags',
'plaid maroon bags contain 1 dull coral bags',
'clear white bags contain 5 plaid lavender bags, 1 faded turquoise bags, 1 mirrored tomato bags, 5 faded silver bags',
...
'drab red bags contain 3 light magenta bags, 1 drab salmon bags, 4 shiny tan bags',
'dotted coral bags contain 1 faded black bags',
'wavy coral bags contain 2 posh white bags, 1 shiny gold bags, 1 striped aqua bags',
'bright aqua bags contain 1 dotted olive bags, 1 striped gold bags',
'bright purple bags contain 1 vibrant purple bags, 2 clear orange bags',
'vibrant lime bags contain 1 dotted turquoise bags, 5 dotted magenta bags, 5 light black bags',
'pale indigo bags contain 5 vibrant chartreuse bags, 5 clear white bags, 1 light lime bags, 3 dull silver bags',
'dull bronze bags contain 4 dark indigo bags, 3 plaid bronze bags, 2 pale yellow bags',
'wavy plum bags contain 5 bright chartreuse bags, 5 pale maroon bags, 1 clear lime bags',
...
'dotted crimson bags contain 1 dotted black bags',
...
'shiny turquoise bags contain 1 posh crimson bags, 1 posh salmon bags, 4 vibrant bronze bags',
'dull fuchsia bags contain 1 mirrored red bags, 3 posh gray bags, 4 plaid maroon bags, 4 clear gold bags',
'light magenta bags contain 3 plaid tan bags',
'faded beige bags contain 5 bright indigo bags, 1 pale yellow bags, 2 vibrant yellow bags',
'mirrored gold bags contain 1 mirrored blue bags, 2 posh fuchsia bags, 5 dark red bags',
'light salmon bags contain 5 muted black bags, 5 dull blue bags, 2 light aqua bags, 1 pale tomato bags',
...
'clear silver bags contain 4 plaid gray bags, 1 dark black bags',
'bright brown bags contain 5 faded chartreuse bags',
'muted olive bags contain 1 dotted red bags, 1 posh green bags',
'striped silver bags contain 3 dotted tomato bags, 1 plaid cyan bags, 4 clear white bags, 5 mirrored indigo bags',
...
'dim crimson bags contain 1 faded chartreuse bags',
'faded orange bags contain 3 bright magenta bags, 4 mirrored brown bags',
'dotted lime bags contain 4 light brown bags, 1 bright white bags, 5 dim lime bags',
'posh turquoise bags contain 4 striped indigo bags, 2 dim white bags',
'dark beige bags contain 1 dark olive bags',
'dotted black bags contain 2 posh turquoise bags, 3 wavy indigo bags, 4 dotted violet bags',
'dotted fuchsia bags contain 5 dark black bags, 1 clear lime bags',
'plaid magenta bags contain 3 posh maroon bags, 4 drab green bags',
'muted coral bags contain 5 light brown bags, 2 posh chartreuse bags, 1 vibrant tan bags',
'striped yellow bags contain 1 light brown bags',
...
'drab fuchsia bags contain 3 shiny aqua bags, 2 plaid lavender bags, 1 muted cyan bags',
'striped maroon bags contain 4 clear lime bags, 5 striped gold bags, 3 clear plum bags, 3 dull tan bags',
'muted yellow bags contain 1 shiny turquoise bags',
'bright silver bags contain 5 striped red bags, 4 dark aqua bags',
'light beige bags contain 1 shiny gold bags, 4 dark orange bags',
'light coral bags contain 3 clear beige bags, 4 shiny maroon bags',
'plaid cyan bags contain 4 pale yellow bags, 1 drab beige bags, 1 bright chartreuse bags, 1 clear coral bags',
'shiny tomato bags contain 3 muted indigo bags, 2 faded indigo bags',
'dark maroon bags contain 1 posh white bags, 2 wavy aqua bags, 5 muted brown bags',
'plaid teal bags contain 1 dull lime bags, 3 faded blue bags, 4 drab cyan bags, 3 clear cyan bags',
'vibrant magenta bags contain 2 wavy tan bags',
'pale tomato bags contain 2 bright silver bags, 1 dull teal bags, 5 dull lime bags, 5 muted aqua bags',
'dim orange bags contain 1 vibrant white bags, 5 bright tomato bags',
'plaid crimson bags contain 2 wavy brown bags, 2 striped maroon bags, 4 dark magenta bags',
'posh beige bags contain 1 faded blue bags',
'dotted gray bags contain 3 drab silver bags, 4 faded silver bags, 2 light coral bags',
'shiny blue bags contain 1 bright magenta bags',
'pale gold bags contain 1 light coral bags, 5 vibrant aqua bags, 2 wavy plum bags, 5 dim lavender bags',
'striped chartreuse bags contain 3 wavy bronze bags',
'vibrant lavender bags contain 3 clear bronze bags, 4 dull yellow bags',
'drab tomato bags contain 1 mirrored aqua bags, 3 drab yellow bags, 2 muted white bags',
...
'dotted tomato bags contain 5 muted fuchsia bags, 3 pale aqua bags, 1 dim aqua bags, 3 dull yellow bags',
...
'dull lime bags contain 1 dull green bags, 3 dark orange bags, 4 shiny maroon bags',
...
'plaid gold bags contain 2 dim lime bags, 1 dull bronze bags, 5 faded fuchsia bags, 2 drab yellow bags',
'faded coral bags contain 1 vibrant green bags, 1 drab yellow bags, 4 wavy teal bags',
'faded bronze bags contain 2 dim lime bags, 4 wavy magenta bags',
'striped turquoise bags contain 5 mirrored magenta bags',
'plaid yellow bags contain 4 mirrored maroon bags, 1 dim silver bags, 3 striped gold bags',
'vibrant coral bags contain 2 mirrored white bags, 1 dull lime bags',
'posh black bags contain 3 clear beige bags, 2 drab gold bags, 3 mirrored indigo bags, 1 dim black bags',
'wavy beige bags contain 1 vibrant purple bags, 4 light green bags, 3 light red bags',
'pale blue bags contain no other bags',
'light silver bags contain 1 posh chartreuse bags, 5 vibrant tan bags',
'mirrored teal bags contain 1 dark tomato bags, 1 wavy teal bags, 3 vibrant maroon bags, 5 pale red bags',
...
'clear gold bags contain 1 bright magenta bags, 3 dotted olive bags, 2 posh yellow bags, 2 dull blue bags',
...
'light lime bags contain 1 light bronze bags',
'vibrant silver bags contain 4 pale tan bags',
'dull plum bags contain 3 vibrant yellow bags, 1 striped plum bags, 2 dim aqua bags',
'mirrored chartreuse bags contain 3 wavy black bags',
'plaid white bags contain 5 dark aqua bags, 1 muted orange bags',
'bright fuchsia bags contain 5 vibrant tan bags',
'drab gold bags contain 1 faded blue bags',
'bright tomato bags contain 1 dim white bags, 1 drab yellow bags',
'dotted chartreuse bags contain 4 dim aqua bags',
'faded fuchsia bags contain 2 light tomato bags, 1 posh yellow bags, 4 faded chartreuse bags, 1 pale blue bags',
'pale silver bags contain 1 drab orange bags, 5 clear salmon bags, 2 plaid violet bags',
...
'muted orange bags contain 1 bright indigo bags, 4 posh yellow bags, 4 bright cyan bags',
...
'wavy cyan bags contain 5 faded aqua bags, 1 striped blue bags, 5 posh olive bags',
'clear teal bags contain 1 mirrored olive bags, 5 dim tomato bags',
'light violet bags contain 2 posh gray bags, 5 dotted cyan bags',
'dark tomato bags contain 5 plaid white bags, 1 wavy indigo bags',
...
'shiny fuchsia bags contain 1 clear cyan bags, 1 striped silver bags, 2 bright black bags',
'striped bronze bags contain 1 dotted lime bags, 4 dark chartreuse bags, 3 shiny bronze bags',
...
'bright chartreuse bags contain 1 dim lime bags',
'mirrored fuchsia bags contain 1 faded chartreuse bags, 3 pale olive bags, 4 pale cyan bags, 2 muted beige bags',
...
'pale fuchsia bags contain 1 dim purple bags, 5 dark gray bags, 2 dim brown bags, 3 wavy tomato bags',
'dull green bags contain 2 dark brown bags, 4 drab indigo bags, 1 mirrored green bags, 2 drab lime bags',
...
'dim fuchsia bags contain 1 dull salmon bags, 1 dull olive bags, 5 shiny yellow bags',
'wavy brown bags contain 1 clear plum bags',
'plaid red bags contain 1 dim indigo bags, 4 muted blue bags',
'light chartreuse bags contain 1 dotted yellow bags, 4 clear gold bags, 1 bright magenta bags, 5 dark tan bags',
'vibrant white bags contain 1 muted gray bags',
'light red bags contain 1 dark bronze bags, 3 shiny lavender bags',
'light bronze bags contain 1 wavy silver bags, 3 plaid lavender bags, 4 drab violet bags, 5 mirrored green bags',
'dark magenta bags contain 5 pale aqua bags',
'striped gray bags contain 1 posh cyan bags',
'dark cyan bags contain 2 drab fuchsia bags, 1 clear cyan bags, 2 plaid gold bags',
'plaid silver bags contain 3 bright beige bags',
'shiny gray bags contain 2 dull blue bags, 2 faded chartreuse bags',
'shiny cyan bags contain 1 striped salmon bags, 4 vibrant tan bags',
'plaid gray bags contain 5 wavy aqua bags, 5 vibrant yellow bags, 1 mirrored indigo bags, 1 faded silver bags',
...
'drab maroon bags contain 1 bright chartreuse bags, 2 dark aqua bags, 3 dim black bags, 5 wavy silver bags',
'light yellow bags contain 5 striped purple bags, 1 faded fuchsia bags, 2 plaid gold bags, 2 dotted olive bags',
...
'clear purple bags contain 3 dim olive bags, 2 mirrored violet bags, 1 muted tomato bags',
'dull brown bags contain 2 faded lime bags, 5 drab violet bags, 1 mirrored green bags',
'vibrant salmon bags contain 5 muted green bags, 4 faded bronze bags, 1 vibrant indigo bags',
'dull silver bags contain 2 light green bags',
'vibrant beige bags contain 2 dull cyan bags',
'muted salmon bags contain 3 bright aqua bags, 2 pale maroon bags, 1 light aqua bags',
...
'dotted turquoise bags contain 1 light tan bags, 2 dull tomato bags',
'posh orange bags contain 1 mirrored cyan bags, 3 shiny cyan bags, 5 bright beige bags, 4 striped lime bags',
...
'pale chartreuse bags contain 1 faded lime bags, 2 light aqua bags, 1 muted coral bags',
'dim magenta bags contain 1 faded chartreuse bags',
'striped tomato bags contain 5 plaid lavender bags, 1 posh beige bags, 1 clear lavender bags, 4 muted indigo bags',
'shiny aqua bags contain 1 wavy gold bags, 1 plaid gold bags',
...
'vibrant orange bags contain 3 dotted lavender bags, 1 posh purple bags, 5 dull cyan bags',
'light lavender bags contain 4 drab cyan bags, 5 posh maroon bags, 3 dotted red bags',
'dark red bags contain 4 faded plum bags',
'plaid chartreuse bags contain 1 posh blue bags',
...
'pale lavender bags contain 1 vibrant plum bags, 5 vibrant yellow bags',
'posh crimson bags contain 2 light brown bags',
'dark blue bags contain 5 mirrored tomato bags, 1 drab coral bags, 3 wavy purple bags',
'dim silver bags contain 5 drab yellow bags, 5 posh purple bags, 3 light tomato bags, 3 wavy blue bags',
'faded maroon bags contain 3 dark salmon bags, 3 faded aqua bags, 1 clear olive bags, 2 clear brown bags',
'dark bronze bags contain 3 dim white bags, 3 bright cyan bags, 4 clear olive bags, 2 faded crimson bags',
'pale orange bags contain 1 light yellow bags, 5 bright olive bags, 2 pale olive bags',
'bright maroon bags contain 3 bright white bags, 1 dotted orange bags',
...
'dull beige bags contain 1 shiny bronze bags, 1 striped crimson bags, 5 plaid indigo bags',
'clear yellow bags contain 3 dim brown bags, 4 dotted lavender bags',
'clear red bags contain 3 shiny indigo bags, 1 vibrant plum bags, 1 dim fuchsia bags, 5 striped teal bags',
...
'dark lavender bags contain 1 vibrant tan bags, 5 plaid lime bags',
'vibrant plum bags contain 1 faded teal bags, 5 shiny plum bags, 3 bright fuchsia bags, 1 shiny coral bags',
'bright beige bags contain 2 mirrored green bags',
'clear beige bags contain 1 posh chartreuse bags, 4 drab cyan bags, 3 light beige bags',
...
'muted cyan bags contain 5 posh tomato bags, 2 drab gray bags, 1 dull indigo bags, 3 pale blue bags',
...
'pale red bags contain 3 plaid lavender bags, 4 plaid beige bags, 1 plaid coral bags, 1 shiny chartreuse bags',
...
'striped coral bags contain 2 striped lime bags, 2 wavy purple bags, 1 striped plum bags',
'mirrored brown bags contain 1 faded lime bags, 5 drab indigo bags, 4 bright white bags',
'faded tomato bags contain 1 dim indigo bags, 5 shiny plum bags, 1 drab yellow bags, 4 drab indigo bags',
...
'shiny red bags contain 1 dull blue bags, 2 bright white bags',
'bright white bags contain 2 faded blue bags',
'dotted salmon bags contain 1 dotted indigo bags',
'faded turquoise bags contain 5 dark orange bags',
'posh plum bags contain 5 faded white bags',
'wavy olive bags contain 5 light aqua bags, 1 pale lavender bags, 5 pale green bags',
'light crimson bags contain 1 muted indigo bags, 2 plaid beige bags',
'mirrored gray bags contain 1 posh lavender bags, 5 wavy indigo bags, 4 dotted crimson bags',
'striped crimson bags contain 2 striped salmon bags, 5 mirrored magenta bags, 4 drab fuchsia bags',
'posh olive bags contain 4 posh fuchsia bags, 1 drab brown bags, 4 dotted red bags',
'clear brown bags contain 1 striped plum bags',
'dark coral bags contain 1 shiny gold bags, 2 faded turquoise bags',
'mirrored violet bags contain 1 dotted gold bags, 3 striped salmon bags, 3 faded crimson bags',
'mirrored black bags contain 5 dull cyan bags, 3 wavy silver bags, 1 posh fuchsia bags',
'bright blue bags contain 3 shiny coral bags',
'light blue bags contain 1 striped indigo bags, 4 dark aqua bags, 3 mirrored tomato bags, 2 vibrant blue bags',
...
'shiny purple bags contain 1 pale gold bags, 1 dull tomato bags',
'dotted olive bags contain 1 drab cyan bags, 4 shiny coral bags',
...
'shiny gold bags contain 1 dull white bags, 4 dark orange bags',
'posh coral bags contain 2 pale olive bags, 5 clear gold bags, 5 posh turquoise bags, 5 wavy olive bags',
'muted crimson bags contain 3 dim black bags, 1 vibrant bronze bags, 3 light black bags',
...
'muted tomato bags contain 1 dim maroon bags, 2 dull yellow bags, 3 vibrant bronze bags, 5 dull blue bags',
'pale cyan bags contain 2 wavy violet bags, 1 clear maroon bags, 2 bright orange bags',
'posh white bags contain 4 dim aqua bags, 5 posh chartreuse bags, 4 drab gold bags',
'wavy crimson bags contain 2 posh maroon bags, 5 clear cyan bags, 1 shiny maroon bags, 2 plaid bronze bags',
'drab purple bags contain 1 shiny gold bags, 5 dotted bronze bags, 4 drab gray bags',
...
'clear aqua bags contain 2 vibrant bronze bags, 1 vibrant indigo bags, 4 mirrored tomato bags',
'muted turquoise bags contain 3 muted cyan bags, 2 light brown bags, 4 light violet bags, 1 posh salmon bags',
...
'dim white bags contain 1 clear gold bags',
...
'dotted plum bags contain 1 muted orange bags',
'dark purple bags contain 3 dark brown bags',
'vibrant yellow bags contain 4 posh chartreuse bags, 1 vibrant bronze bags',
'bright gold bags contain 4 dotted tomato bags',
'faded brown bags contain 1 clear cyan bags, 4 faded purple bags',
...
'vibrant teal bags contain 3 shiny bronze bags, 5 mirrored green bags, 3 plaid aqua bags, 1 bright olive bags',
'mirrored plum bags contain 1 dark crimson bags, 2 striped gray bags, 3 posh white bags',
'striped red bags contain 1 dotted black bags, 1 mirrored magenta bags, 3 shiny blue bags',
'shiny beige bags contain 5 striped salmon bags, 2 bright cyan bags, 4 striped crimson bags',
'clear orange bags contain 1 faded chartreuse bags',
'striped beige bags contain 2 plaid green bags, 1 bright turquoise bags, 1 drab chartreuse bags',
'muted fuchsia bags contain 4 dotted violet bags, 1 vibrant silver bags, 1 shiny cyan bags, 1 vibrant yellow bags',
'dim lavender bags contain 4 muted cyan bags, 1 striped violet bags',
'dull red bags contain 5 posh bronze bags, 3 clear turquoise bags, 1 bright green bags, 1 vibrant white bags',
'mirrored blue bags contain 5 faded olive bags, 5 light aqua bags',
'bright crimson bags contain 1 posh olive bags, 5 faded white bags',
'drab silver bags contain 1 muted orange bags, 3 dull green bags, 3 dim aqua bags, 2 striped fuchsia bags',
'clear fuchsia bags contain 4 drab gold bags',
'vibrant olive bags contain 2 light brown bags, 1 vibrant red bags',
...
'dim blue bags contain 1 bright silver bags, 4 bright cyan bags',
...
'vibrant purple bags contain 3 vibrant white bags, 1 posh beige bags',
...
'dull salmon bags contain 1 faded blue bags, 2 wavy silver bags, 3 posh chartreuse bags',
...
'bright red bags contain 1 posh turquoise bags, 4 clear aqua bags',
...
'pale plum bags contain 4 drab black bags, 4 vibrant purple bags, 1 muted turquoise bags',
...
'striped blue bags contain 1 striped chartreuse bags',
'muted plum bags contain 2 posh tomato bags, 4 faded lime bags, 5 dull bronze bags, 5 wavy lime bags',
'faded yellow bags contain 2 dotted tomato bags, 3 muted yellow bags, 1 dim bronze bags',
'dull chartreuse bags contain 2 striped red bags',
'dotted tan bags contain 4 light aqua bags',
'bright indigo bags contain 2 posh tomato bags, 5 vibrant indigo bags, 2 posh chartreuse bags, 1 wavy silver bags',
...
'dull magenta bags contain 5 dull fuchsia bags, 1 drab green bags, 1 wavy red bags, 1 wavy fuchsia bags',
...
'posh salmon bags contain 1 dull green bags, 2 bright cyan bags, 1 mirrored bronze bags',
'light brown bags contain 3 posh chartreuse bags, 5 mirrored bronze bags',
'posh silver bags contain 1 dim yellow bags, 1 clear tan bags',
'muted brown bags contain 5 dotted maroon bags, 4 shiny yellow bags, 5 dark orange bags',
'drab coral bags contain 4 faded chartreuse bags, 1 vibrant bronze bags, 5 shiny bronze bags, 3 vibrant tan bags',
...
'dim coral bags contain 1 clear bronze bags, 2 dark gold bags, 3 drab teal bags',
'vibrant gold bags contain 3 dark chartreuse bags, 1 posh purple bags, 1 striped white bags, 2 dotted chartreuse bags',
...
'clear cyan bags contain 1 dark gray bags, 4 vibrant indigo bags',
...
'dark turquoise bags contain 1 drab violet bags, 5 drab gold bags, 1 mirrored green bags',
'vibrant bronze bags contain 3 dim aqua bags, 3 light aqua bags, 3 wavy silver bags, 2 posh tomato bags',
'posh fuchsia bags contain 3 dark brown bags, 5 striped indigo bags, 1 muted indigo bags, 4 mirrored bronze bags',
'posh blue bags contain 4 clear black bags',
'mirrored salmon bags contain 1 dotted gray bags, 3 clear gold bags, 5 dark indigo bags, 2 striped gold bags',
'dark gold bags contain 2 vibrant blue bags, 3 muted indigo bags',
'dark chartreuse bags contain 4 shiny tan bags, 1 wavy lavender bags, 3 vibrant olive bags, 3 light green bags',
...
'clear blue bags contain 4 shiny cyan bags, 1 striped fuchsia bags',
'shiny white bags contain 4 faded tan bags, 2 shiny gold bags, 1 shiny bronze bags, 1 dim coral bags',
'bright black bags contain 5 shiny gray bags, 3 dull bronze bags, 4 striped gold bags',
'faded silver bags contain 3 clear gold bags, 4 dotted cyan bags, 1 light white bags, 4 dull green bags',
...
'plaid orange bags contain 5 light beige bags, 1 dull salmon bags',
...
'vibrant gray bags contain 1 clear magenta bags',
'plaid purple bags contain 1 light aqua bags, 5 vibrant tan bags, 4 pale tan bags, 4 wavy bronze bags',
'faded blue bags contain no other bags',
'pale turquoise bags contain 1 vibrant gray bags, 3 plaid purple bags, 5 drab coral bags, 5 plaid indigo bags',
'vibrant tan bags contain 4 pale yellow bags',
'striped gold bags contain 1 dull salmon bags',
'faded indigo bags contain 4 faded chartreuse bags, 2 wavy silver bags, 1 shiny green bags',
'light plum bags contain 2 faded chartreuse bags, 1 plaid lime bags, 1 posh violet bags, 5 faded plum bags',
'dim indigo bags contain 2 dim black bags, 1 wavy plum bags, 4 dark blue bags',
'mirrored bronze bags contain 4 dark gold bags, 4 posh tomato bags, 2 plaid aqua bags',
'posh indigo bags contain 2 dim maroon bags, 1 dotted gray bags, 4 dark brown bags, 3 wavy indigo bags',
...
'drab bronze bags contain 1 dotted brown bags, 5 clear beige bags',
...
'shiny bronze bags contain 5 light tomato bags, 1 dull blue bags, 4 dark black bags, 1 posh chartreuse bags',
'clear green bags contain 1 light green bags, 5 dim plum bags',
'wavy black bags contain 3 clear fuchsia bags, 2 striped violet bags, 1 vibrant indigo bags',
'posh lime bags contain 5 pale cyan bags, 3 clear fuchsia bags, 1 posh white bags, 4 dark turquoise bags',
...
'dotted red bags contain 4 dim tomato bags, 1 drab beige bags',
'wavy white bags contain 5 plaid crimson bags, 2 light magenta bags',
'muted teal bags contain 5 dim crimson bags, 1 dim cyan bags',
'bright lavender bags contain 2 dark lavender bags, 2 mirrored cyan bags, 1 dim yellow bags, 5 vibrant teal bags',
'clear coral bags contain 2 drab beige bags, 1 drab yellow bags, 1 dotted tan bags',
'clear gray bags contain 3 plaid lime bags, 1 dull beige bags, 5 light beige bags',
...
'clear violet bags contain 4 posh bronze bags, 1 pale gold bags']
...
function find(value) {
  if(value && !value.includes('no other bags')){
    let arr = rules;
    let result = arr.filter(rule => rule[1].includes(value)).map(x => x[0].trim());
    result.forEach(r => {
