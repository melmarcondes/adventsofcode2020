  ...
  /* console.log("*******************************************************");    
   ...
   console.log(input);*/
    for(var i = 0; i < input.length; i++){
	  let previousLine = (i > 0) ? [...input[i-1]] : null;
      let line = [...input[i]];
	  let nextLine = (i < input.length - 1) ?[...input[i+1]] : null;
	  let newLine = "";
	  ...
	  //console.log("nextLine:"+nextLine);
   	  for(var j = 0; j < line.length; j++){
    	      ...
    	      const isOccupied =  current === '#';
     	      ...
     	      let left = (j > 0) ? line[j-1] : "*";
    	      let right = (j < line.length - 1) ? line[j+1] : "*";
    
    	      let above = previousLine ? 
    			   left !== "*" ? 
    			      right !== "*" ?
    				    previousLine[j-1] + previousLine[j] + previousLine[j+1]
    			      : previousLine[j-1] + previousLine[j] 
    			   : right !== "*" ? previousLine[j+1] + previousLine[j] : previousLine[j] 
    			  : "*";
    	      ...
    	      let below = nextLine ? 
    			   ...
    			   : right !== "*" ? nextLine[j+1] + nextLine[j] : nextLine[j] 
    			  : "*";
	...
	input = [...newInput];	
	//newInput.splice(0, newInput.length);
